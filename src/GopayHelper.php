...
class GopayHelper
{
	...
	)
	{
		...
		$output .= '<input type="hidden" name="paymentCommand.preAuthorization" value="' . GopayHelper::castBoolean2String($preAuthorization) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.recurrentPayment" value="' . GopayHelper::castBoolean2String($recurrentPayment) . '" />' . "\n";
