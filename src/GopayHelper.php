...
use Exception;
use Markette\Gopay\Api\Crypt\Crypt;
...
class GopayHelper
{
						...
						if ($sessionState == self::PAYMENT_METHOD_CHOSEN) {
							if (!empty($sessionSubState) && $sessionSubState == 101) {
								...
								if (!empty($sessionSubState) && $sessionSubState == 102) {
									...
									$result = self::PAYMENT_METHOD_CHOSEN_MESSAGE;
	...
	)
	{
		 ...
		 */
		$hashedSignature = self::hash(
			self::concatPaymentStatus(
	...
	)
	{
		...
		$output = '';
		$output .= "<form method='post' action='" . GopayConfig::baseIntegrationURL() . "'>\n";
		$output .= '<input type="hidden" name="paymentCommand.targetGoId" value="' . $targetGoId . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.productName" value="' . trim($productName) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.totalPrice" value="' . $totalPrice . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.currency" value="' . trim($currency) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.orderNumber" value="' . trim($orderNumber) . '"/>' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.successURL" value="' . trim($successURL) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.failedURL" value="' . trim($failedURL) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.paymentChannels" value="' . trim($paymentChannelsString) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.defaultPaymentChannel" value="' . trim($defaultPaymentChannel) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.encryptedSignature" value="' . $encryptedSignature . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.preAuthorization" value="' . self::castBoolean2String($preAuthorization) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.recurrentPayment" value="' . self::castBoolean2String($recurrentPayment) . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.recurrenceDateTo" value="' . $recurrenceDateTo . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.recurrenceCycle" value="' . $recurrenceCycle . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.recurrencePeriod" value="' . $recurrencePeriod . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.firstName" value="' . $firstName . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.lastName" value="' . $lastName . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.city" value="' . $city . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.street" value="' . $street . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.postalCode" value="' . $postalCode . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.countryCode" value="' . $countryCode . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.email" value="' . $email . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.customerData.phoneNumber" value="' . $phoneNumber . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.p1" value="' . $p1 . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.p2" value="' . $p2 . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.p3" value="' . $p3 . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.p4" value="' . $p4 . '" />' . "\n";
		$output .= '<input type="hidden" name="paymentCommand.lang" value="' . $lang . '" />' . "\n";
		$output .= '<input type="submit" name="buy" value="Zaplatit" class="button">' . "\n";
		$output .= "</form>\n";
	...
	)
	{
		...
		$params .= '&paymentCommand.preAuthorization=' . self::castBoolean2String($preAuthorization);
		$params .= '&paymentCommand.recurrentPayment=' . self::castBoolean2String($recurrentPayment);
